...
from . import ReportCreation, Searching
...
def format_search_results(results: Searching.SearchResult):
    ...
    html_table = context_df.to_html(classes='table table-bordered table-hover align-middle', table_id="dataTable", justify = "center", index=False, escape=False)
