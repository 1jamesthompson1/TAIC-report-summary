...
abstract: This project sets out to explore and test the validity of using LLMs (GPT 3.5 and 4) to summarize and reason about Marine Accidents. This was achieved by building an engine that uses GPT 3.5 and 4 to read all of the marine reports and provide global themes as well as weightings for each reports. This resulted in output that was sensible and close to the human generated validation set. Further work will be needed to further validate the results and develop the depth of the engine. To help make the output of the engine accessible a basic web app with search functionality was built.
---
